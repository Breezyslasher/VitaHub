/**
 * VitaHub platform layer — iOS / tvOS implementation (.mm Objective-C++).
 *
...
// The display mode is the OS's business on this port; VitaHub neither switches
...
std::string getLogPath() {
    return getIosDataDir() + "/vitahub.log";
}
...
// Lives in the vitahub namespace, where VitaHub's import wraps paths.hpp.
namespace vitahub {
