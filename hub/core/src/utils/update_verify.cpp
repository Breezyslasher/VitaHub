/**
 * VitaHub - update artifact signature verification (see update_verify.hpp).
 */
...
// to the stub at the bottom. CMake defines VITAHUB_HAVE_MBEDCRYPTO for the
// former set.
#if defined(VITAHUB_HAVE_MBEDCRYPTO)
