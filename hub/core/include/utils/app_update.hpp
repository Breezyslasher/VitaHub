 ...
 * VitaHub's HttpClient and release layout. The offer names the new and
 ...
 *              (0x80101114 = in use), so VitaHub installs and launches a
 *              tiny bundled updater stub (VHUBUPD01) and quits; with
 *              VitaHub closed the stub promotes the .vpk and relaunches
 *              VitaHub (the AutoPlugin2 technique, utils/vita_install +
 *              src/updater_stub). VitaHub removes the leftover stub on its
