...
namespace vitasuwayomi { namespace platform {
...
int64_t fileSize(const std::string& path) {
    // Regular files only; directories must report -1 so callers recurse into
    // them instead of counting a bogus directory size.
    struct stat st;
