...
Certificate Certificate::Generate(CertificateType type, const string &commonName) {
	...
	// source on EVERY drbg call; ECDSA keygen + signing make hundreds of them,
	// turning certificate generation into a ~30s stall. PR off is the mbedTLS
	// default and standard practice for certificate generation.
