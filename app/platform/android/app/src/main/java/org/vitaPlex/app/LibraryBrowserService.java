 ...
 * Google Assistant ("play X on VitaHub"), Wear, and Android TV.
 *
...
public final class LibraryBrowserService extends MediaBrowserServiceCompat {
    private static final String TAG = "VitaHubBrowse";
    ...
    public void onLoadChildren(String parentId, Result<List<MediaBrowserCompat.MediaItem>> result) {
        ...
        try {
            ...
            deliverChildren(token,
                    ...
                    new String[] { "Open VitaHub to browse your library" },
                    new String[] { "" },
                    new String[] { "" },
                    new int[] { 0 });
        }
    ...
    /**
     * "Hey Google, play <something> on VitaHub" — routed here from the
