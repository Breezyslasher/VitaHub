...
public final class MediaNotification {
    private static final String TAG = "VitaHubMedia";
    ...
    private static void applyUpdate() {
        ...
        long actions = PlaybackStateCompat.ACTION_PLAY_PAUSE | PlaybackStateCompat.ACTION_PLAY
            ...
            // Assistant only offers "play X on VitaHub" when the session says
        ...
        try {
            if (playing) {
                if (sWakeLock == null) {
                    ...
                    if (pm != null) {
                        sWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "VitaHub:music");
                ...
                if (sWifiLock == null) {
                    ...
                    if (wm != null) {
                        sWifiLock = wm.createWifiLock(
                            WifiManager.WIFI_MODE_FULL_HIGH_PERF, "VitaHub:music");
    ...
    private static void ensureSession(Context ctx) {
        ...
        sSession = new MediaSessionCompat(ctx, "VitaHub", mbr,
        ...
        sSession.setCallback(new MediaSessionCompat.Callback() {
            ...
            // Spoken requests: "play <album> on VitaHub". Prepare-variants are
